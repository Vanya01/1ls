import './App.css';
import {Users} from "./Components/Elements/Persons";
...
function App() {
    return (
        <div className={'all_users'}>
            <Users user={usersList} i={0}/>
                <Users user={usersList} i={1}/>
                <Users user={usersList} i={2}/>
                <Users user={usersList} i={3}/>
                <Users user={usersList} i={4}/>
                <Users user={usersList} i={5}/>
                <Users user={usersList} i={6}/>
                <Users user={usersList} i={7}/>
                <Users user={usersList} i={8}/>
                <Users user={usersList} i={9}/>
        </div>
    )
}
